...
const FlashcardView = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Duel | {deckId}</title>
        <meta name="description" content={`View flashcards for ${deckId}`} />
        <meta property="og:title" content={`Duel | ${deckId}`} />
        <meta
          property="og:description"
          content={`View flashcards for ${deckId}`}
        />
        <link rel="canonical" href={`https://duel.work/flashcards/${deckId}`} />
      </Helmet>
